...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'editor', loadComponent: () => import('./showcase/pages/editor.page').then((m) => m.EditorPage) },
      ...
      { path: 'office', loadComponent: () => import('./showcase/pages/office.page').then((m) => m.OfficePage) },
      ...
      { path: 'examples/kanban', loadComponent: () => import('./showcase/examples/kanban.example').then((m) => m.KanbanExample) },
      { path: 'examples/calendar', loadComponent: () => import('./showcase/examples/calendar.example').then((m) => m.CalendarExample) },
      { path: 'examples/chat', loadComponent: () => import('./showcase/examples/chat.example').then((m) => m.ChatExample) },
      { path: 'examples/dashboard', loadComponent: () => import('./showcase/examples/dashboard.example').then((m) => m.DashboardExample) },
    ],
  },
  { path: '**', redirectTo: '' },
];
