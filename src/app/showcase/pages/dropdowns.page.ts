    ...
    >
      ...
      >
        <atm-dropdown [items]="menuItems" (itemClick)="toast.info('Clicou', $event.label)">
          <atm-button variant="outline" color="neutral" iconRight="chevron-down">Ações</atm-button>
        </atm-dropdown>
        ...
        >
          <atm-button variant="soft" iconRight="chevron-down">Com footer</atm-button>
        </atm-dropdown>
      </demo-section>
        ...
        <div class="flex w-full flex-col gap-4">
          ...
          <div class="w-full max-w-md overflow-hidden rounded-atm border border-line">
            @for (file of files; track file.name) {
              ...
              >
                <i [class]="'text-ink-muted atm atm-' + file.icon" aria-hidden="true"></i>
...
export class DropdownsPage {
  ...
  readonly menuItems: AtmDropdownItem[] = [
    { label: 'Editar', icon: 'edit-02', shortcut: 'Ctrl+E' },
  ...
  readonly files = [
    { name: 'relatorio-2026.pdf', icon: 'pdf-01', size: '1,2 MB' },
    { name: 'vendas.xlsx', icon: 'xls-01', size: '340 KB' },
  ...
  readonly areaItems: AtmContextMenuItem[] = [
    ...
    { label: 'Nova pasta', value: 'new-folder', icon: 'folder-01', separatorBefore: true },
    { label: 'Novo arquivo', value: 'new-file', icon: 'txt-01' },
  ];

  readonly fileItems: AtmContextMenuItem[] = [
    { label: 'Abrir', value: 'open', icon: 'link-square-01' },
    { label: 'Renomear', value: 'rename', icon: 'edit-02', shortcut: 'F2' },
...
>
  <atm-button variant="outline" iconRight="chevron-down">Ações</atm-button>
</atm-dropdown>`;
