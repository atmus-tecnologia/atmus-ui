# atm-image-crop-dialog

> Doc otimizada para LLMs. Fonte: `projects/ngui/src/lib/components/image-crop/image-crop.component.ts`

## Purpose

Dialog wrapper para recorte de imagem.
...
```html
<!-- Preferir via AtmDialogService / showcase -->
```
